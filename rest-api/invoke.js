...
exports.invokeTransaction = async (channelName, chaincodeName, fcn, args, username, organization) => {
    ...
    if (fcn == "CreateUser") {
        ...
        // Record user in the ledger
        console.log('\n--> Submit Transaction: CreateUser, function records a new user on the ledger');
        await contract.submitTransaction('CreateUser', username);
